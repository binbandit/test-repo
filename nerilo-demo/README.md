...
The greeting feature is also exercised while a newer base revision arrives during CI.

Strict branch protection requires the PR to include the latest base revision before merging.
